...
Analiza prognozowanego czasu przeżycia wykazała, że wartości tej zmiennej różniły się pomiędzy grupami wiekowymi, typami zabiegów chirurgicznych oraz kombinacjami stosowanych terapii. Widoczna była duża zmienność wyników w obrębie poszczególnych kategorii, co wskazuje na heterogeniczny charakter badanej populacji.

Zarówno w grupie pacjentek po zabiegu oszczędzającym pierś, jak i po mastektomii, nie zaobserwowano jednoznacznej przewagi jednej metody chirurgicznej pod względem przewidywanego czasu przeżycia. Sugeruje to, że rokowanie pacjentek zależy od współdziałania wielu czynników klinicznych oraz zastosowanego leczenia.

Widoczne różnice pomiędzy poszczególnymi kombinacjami terapii wskazują, że sposób leczenia może wpływać na przewidywany czas przeżycia pacjentek. Jednocześnie szerokie rozstępy międzykwartylowe i obecność wartości odstających świadczą o znacznym zróżnicowaniu indywidualnego rokowania.

Najwyższe mediany prognozowanego czasu przeżycia obserwowano dla wybranych kombinacji terapii zarówno w grupie pacjentek poddanych zabiegowi oszczędzającemu pierś, jak i po mastektomii, jednak zależności te nie były jednakowe we wszystkich grupach wiekowych.
...
rozkład prawdopodobieństwa prognozowanych lat przeżycia od diagnozy
...
przykład średnia ilość prognozowanych miesięcy przeżycia zmniejsza się
